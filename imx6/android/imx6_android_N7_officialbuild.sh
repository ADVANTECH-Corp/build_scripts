...
echo "[ADV] ANDROID_PATCH = $CURR_PATH/$ROOT_DIR/patches_android_7.1.1"
...
AND_BSP="android"
AND_BSP_VER="7.1"
AND_VERSION="android_N7.1.1_1.1.0"
...
function generate_csv()
{
    ...
    HASH_PATCH=$(cd $CURR_PATH/$ROOT_DIR/patches_android_7.1.1 && git rev-parse --short HEAD)
...
# Add git tag
	...
	auto_add_tag $CURR_PATH/$ROOT_DIR/patches_android_7.1.1
# ------------REMOVE FOR TEST   ------------- #
