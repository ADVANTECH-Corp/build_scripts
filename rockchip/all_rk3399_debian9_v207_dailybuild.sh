...
MACHINE_LIST=""
#rk_BSP
./rk3399_debian9_v207_dailybuild.sh rk $VERSION_NUM
...
export MACHINE_LIST
./rk3399_debian9_v207_dailybuild.sh ds100 $VERSION_NUM
fi
#DS100Lite_projects
if [ "$DS100L" == "true" ]; then
...
export KERNEL_CONFIG
export MACHINE_LIST
./rk3399_debian9_v207_dailybuild.sh ds100l $VERSION_NUM
fi
