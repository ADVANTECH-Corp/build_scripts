...
if [ "$ROCK101A2" == "true" ]; then
	UBOOT_DEFCONFIG=rk3568_rock101a2
	KERNEL_DEFCONFIG=rk3568_adv_defconfig
	KERNEL_DTB=rk3568-rock101-a2.img
	MACHINE_LIST="$MACHINE_LIST ROCK101"
	MODEL_NAME="ROCK101"
	HW_VER="A2"
	BOARD_CONFIG="BoardConfig-rk3568-rock101a2.mk"
...
if [ "$ROM5880B1" == "true" ]; then
	UBOOT_DEFCONFIG=rk3568_rom5880b1
	KERNEL_DEFCONFIG=rk3568_adv_defconfig
	KERNEL_DTB=rk3568-rom5880-b1.img
	MACHINE_LIST="$MACHINE_LIST ROM5880"
	MODEL_NAME="ROM5880"
	HW_VER="B1"
	BOARD_CONFIG="BoardConfig-rk3568-rom5880b1.mk"
...
if [ "$EBCRB07A1" == "true" ]; then
	...
	KERNEL_DEFCONFIG=rk3568_rb07_defconfig
